...
import br.dev.gee.sdnapster.common.RemoteChunkMap;
import br.dev.gee.sdnapster.common.MD5;

public class RemoteChunkMapImpl extends UnicastRemoteObject implements RemoteChunkMap {
    private static ConcurrentHashMap<String, HashMap<String, Set<MD5>>> chunkMapByHost;

    public RemoteChunkMapImpl() throws RemoteException {
        super();
    }
